  ...
  AuthBloc(AuthProvider provider) : super(const AuthStateUninitialised(isLoading: true)) {
    ...
    on<AuthEventLogIn>(
      (event, emit) async {
        emit(const AuthStateLoggedOut(
          exception: null,
          isLoading: true,
          loadingText: 'Please wait while you\'re being logged in',
        ));
    ...
    on<AuthEventForgotPassword>(
      (event, emit) async {
        ...
        // rmit the loading state forgot password process
        emit(const AuthStateForgotPassword(
          exception: null,
          emailSent: false,
          isLoading: true,
        ...
        // processing the passwd reset procedure
